                            ...
                            <div class="card mb-4">
                                <div class="card-body text-dark font-weight-bold">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm">
                                            <input type="text" class="form-control" id="id_brg" name="id_brg" value="<?= $ubah_barang['id_brg']; ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm">
                                            <input type="text" class="form-control text-capitalize" id="nm_brg" name="nm_brg" maxlength="30" value="<?= $ubah_barang['nm_brg']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm">
                                            <img src="<?= base_url('assets/brg/') ?><?=$ubah_barang['img']?>" alt="" width="200" height="150">
                                            <input type="file" class="form-control text-capitalize" id="gambar_barang" name="gambar_barang" maxlength="30" placeholder="Masukkan nama barang">
                                    ...
                                    <div class="form-group">
                                        <label>Harga</label>
                                        <div class="col-sm">
                                            <input type="number" class="form-control" id="harga" name="harga" min="1" max="9999999999" value="<?= $ubah_barang['harga_brg']; ?>">
